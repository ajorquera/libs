...
class Endpoint {
  ...
  post <T=unknown>(body: TObj<T>, urlParams?: EndpointProps['urlParams'], config?: Partial<EndpointProps & FetchProps>) {
  ...
  put <T=unknown>(body: TObj<T>, urlParams?: EndpointProps['urlParams'], config?: Partial<EndpointProps & FetchProps>) {
