...
export const getMargin = (props: { style: MarginProps }) => {
    ...
    const newProps = removeProps(['marginTop', 'marginRight', 'marginBottom', 'marginLeft', 'margin', 'mt', 'mr', 'mb', 'ml', 'my', 'mx'])(props as any);
...
export const getPadding = (props: { style: PaddingProps }) => {
    ...
    const newProps = removeProps(['paddingTop', 'paddingRight', 'paddingBottom', 'paddingLeft', 'padding', 'pt', 'pr', 'pb', 'pl', 'px', 'py'])(props as any);
